...
/// <reference path="cordova-plugin-app-version/cordova-plugin-app-version.d.ts" />
/// <reference path="cordova-plugin-certificate/cordova-plugin-certificate.d.ts" />
/// <reference path="cordova-plugin-x-toast/toast.d.ts" />
